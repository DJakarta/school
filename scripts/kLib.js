		...
		functions: {
			...
			parse: function (string) {
				...
				if (typeof string==='string') {
					...
					else if (r.rgbColor.test(string)) {
					...
					else if (r.rgbaColor.test(string)) {
					...
					else if (r.hslColor.test(string)) {
					...
					else if (r.hslaColor.test(string)) {
